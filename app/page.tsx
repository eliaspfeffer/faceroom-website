      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 780, width: "100%" }}>
          ...
          >
            ...
            <a
              href="https://github.com/eliaspfeffer/faceroom-electron/releases/latest/download/Faceroom-Linux.AppImage"
              className="btn-secondary"
              title="Linux x64 — AppImage. Also available as .deb."
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M12.504 0c-.155 0-.315.008-.48.021-4.226.333-3.105 4.807-3.17 6.298-.076 1.092-.3 1.953-1.05 3.02-.885 1.051-2.127 2.75-2.716 4.521-.278.832-.41 1.684-.287 2.489a.95.95 0 0 0-.183.179c-.392.471-.504.741-.674.948-.165.198-.376.318-.731.41-.355.094-.834.183-1.353.456-.587.31-.825.831-.829 1.323-.011 1.265 1.05 1.876 1.91 2.39.605.36 1.082.808 1.475 1.137.39.328.713.583 1.062.685.196.058.405.084.624.084.388 0 .768-.144 1.05-.41.345-.31.595-.654.69-.847.27-.512.515-1.054.69-1.625l.4-.094c.158-.038.318-.083.476-.135.255-.083.503-.181.738-.295.155-.075.305-.157.453-.243.272-.158.531-.337.787-.526.213-.157.421-.322.625-.494.36-.305.7-.625 1.022-.952.198-.202.392-.41.582-.622.34-.378.667-.768.984-1.165.31-.388.609-.78.901-1.177.302-.41.602-.823.901-1.237.314-.434.624-.87.93-1.31l.097-.144c.299-.43.59-.866.873-1.31.298-.466.586-.94.866-1.418l.014-.024c.295-.504.578-1.015.851-1.532.252-.476.49-.961.717-1.451.247-.535.476-1.079.69-1.629.187-.481.358-.967.515-1.46.176-.55.336-1.107.482-1.668.124-.476.236-.96.336-1.448l.012-.063c.029-.143.057-.286.083-.43l.012-.066c.041-.224.084-.45.117-.677.027-.183.046-.367.057-.552.011-.183.013-.366.005-.55a4.49 4.49 0 0 0-.05-.572 4.197 4.197 0 0 0-.146-.622 3.732 3.732 0 0 0-.265-.628 3.305 3.305 0 0 0-.4-.591A2.927 2.927 0 0 0 14.488.273a3.022 3.022 0 0 0-.732-.207A3.357 3.357 0 0 0 12.504 0z" />
              </svg>
              Download for Linux
            </a>
            <span
              className="btn-secondary"
              title="Windows build is in progress."
          ...
          >
            Linux: AppImage (`chmod +x` and run) or{" "}
            <a
              href="https://github.com/eliaspfeffer/faceroom-electron/releases/latest/download/Faceroom-Linux.deb"
